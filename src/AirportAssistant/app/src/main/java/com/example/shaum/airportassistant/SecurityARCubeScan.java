...
public class SecurityARCubeScan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_security_ar_cube_scan);
        ...
        btComplete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(SecurityARCubeScan.this, SecurityARCubeResults.class);
                startActivity(i);
                finish();
            }
        ...
        btQuit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(SecurityARCubeScan.this, SecurityARCubeGuide.class);
                startActivity(i);
                finish();
            }
        });
